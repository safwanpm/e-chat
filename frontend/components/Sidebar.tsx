...
export const Sidebar = ({
  ...
  const { users, isViewUsersLoading, getUsers, onlineUserIds } = useChatStore();
  ...
  // ✅ FIXED: Explicitly typed as ChatUser[] to resolve the "status" type error
  const updatedUsers: ChatUser[] = users.map((user) => ({
    ...user,
